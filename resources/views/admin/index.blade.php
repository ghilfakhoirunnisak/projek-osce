...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
    ...
    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="{{ route('dashboard') }}" class="b-brand text-primary d-block text-center fs-2 fw-bold">
                    OSCE
                </a>
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item {{ request()->routeIs('mahasiswa.*') ? 'active' : '' }}">
                    ...
                    <li class="pc-item {{ request()->routeIs('penguji.*') ? 'active' : '' }}">
                        <a href="{{ route('penguji.index') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-user-check"></i></span>
                            <span class="pc-mtext">Penguji</span>
                        </a>
                    </li>

                    <li class="pc-item {{ request()->routeIs('station.*') ? 'active' : '' }}">
                        <a href="{{ route('station.index') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-map-pin"></i></span>
                            <span class="pc-mtext">Station</span>
                        </a>
                    </li>

                    <li class="pc-item {{ request()->routeIs('jadwal.*') ? 'active' : '' }}">
                        <a href="{{ route('jadwal.index') }}" class="pc-link">
